...
static void TEST_SIGN_AIMER128F(void)
{
    ...
    for(int i = 0; i < TEST_LOOP; i++)
    {
        ...
        kucp_aimer128f_avx2_crypto_sign_keypair(pk, sk);

        kucp_aimer128f_avx2_crypto_sign(sm, &smlen, m, MLEN, sk);

        ret = kucp_aimer128f_avx2_crypto_sign_open(m2, &mlen, sm, smlen, pk);
...
static void TEST_SIGN_AIMER128S(void)
{
    ...
    for(int i = 0; i < TEST_LOOP; i++)
    {
        ...
        kucp_aimer128s_avx2_crypto_sign_keypair(pk, sk);

        kucp_aimer128s_avx2_crypto_sign(sm, &smlen, m, MLEN, sk);

        ret = kucp_aimer128s_avx2_crypto_sign_open(m2, &mlen, sm, smlen, pk);
...
static void TEST_SIGN_AIMER192F(void)
{
    ...
    for(int i = 0; i < TEST_LOOP; i++)
    {
        ...
        kucp_aimer192f_avx2_crypto_sign_keypair(pk, sk);

        kucp_aimer192f_avx2_crypto_sign(sm, &smlen, m, MLEN, sk);

        ret = kucp_aimer192f_avx2_crypto_sign_open(m2, &mlen, sm, smlen, pk);
...
static void TEST_SIGN_AIMER192S(void)
{
    ...
    for(int i = 0; i < TEST_LOOP; i++)
    {
        ...
        kucp_aimer192s_avx2_crypto_sign_keypair(pk, sk);

        kucp_aimer192s_avx2_crypto_sign(sm, &smlen, m, MLEN, sk);

        ret = kucp_aimer192s_avx2_crypto_sign_open(m2, &mlen, sm, smlen, pk);
...
static void TEST_SIGN_AIMER256F(void)
{
    ...
    for(int i = 0; i < TEST_LOOP; i++)
    {
        ...
        kucp_aimer256f_avx2_crypto_sign_keypair(pk, sk);

        kucp_aimer256f_avx2_crypto_sign(sm, &smlen, m, MLEN, sk);

        ret = kucp_aimer256f_avx2_crypto_sign_open(m2, &mlen, sm, smlen, pk);
...
static void TEST_SIGN_AIMER256S(void)
{
    ...
    for(int i = 0; i < TEST_LOOP; i++)
    {
        ...
        kucp_aimer256s_avx2_crypto_sign_keypair(pk, sk);

        kucp_aimer256s_avx2_crypto_sign(sm, &smlen, m, MLEN, sk);

        ret = kucp_aimer256s_avx2_crypto_sign_open(m2, &mlen, sm, smlen, pk);
...
static void TEST_SIGN_CLOCK_AIMER128F(void)
{
    ...
    for(int i = 0; i < TEST_LOOP; i++)
    {
        ...
        cycles1 = cpucycles();
        kucp_aimer128f_avx2_crypto_sign_open(m2, &mlen, sm, smlen, pk);
		cycles2 = cpucycles();
...
static void TEST_SIGN_CLOCK_AIMER128S(void)
{
    ...
    for(int i = 0; i < TEST_LOOP; i++)
    {
        ...
        cycles1 = cpucycles();
        kucp_aimer128s_avx2_crypto_sign_open(m2, &mlen, sm, smlen, pk);
		cycles2 = cpucycles();
		dcycles += cycles2-cycles1 - cyclegap;
...
static void TEST_SIGN_CLOCK_AIMER192F(void)
{
    ...
    for(int i = 0; i < TEST_LOOP; i++)
    {
        ...
        cycles1 = cpucycles();
        kucp_aimer192f_avx2_crypto_sign_open(m2, &mlen, sm, smlen, pk);
		cycles2 = cpucycles();
		dcycles += cycles2-cycles1 - cyclegap;
...
static void TEST_SIGN_CLOCK_AIMER192S(void)
{
    ...
    for(int i = 0; i < TEST_LOOP; i++)
    {
        ...
        cycles1 = cpucycles();
        kucp_aimer192s_avx2_crypto_sign_open(m2, &mlen, sm, smlen, pk);
		cycles2 = cpucycles();
		dcycles += cycles2-cycles1 - cyclegap;
...
static void TEST_SIGN_CLOCK_AIMER256F(void)
{
    ...
    for(int i = 0; i < TEST_LOOP; i++)
    {
        ...
        cycles1 = cpucycles();
        kucp_aimer256f_avx2_crypto_sign_open(m2, &mlen, sm, smlen, pk);
		cycles2 = cpucycles();
		dcycles += cycles2-cycles1 - cyclegap;
...
static void TEST_SIGN_CLOCK_AIMER256S(void)
{
    ...
    for(int i = 0; i < TEST_LOOP; i++)
    {
        ...
        cycles1 = cpucycles();
        kucp_aimer256s_avx2_crypto_sign_open(m2, &mlen, sm, smlen, pk);
		cycles2 = cpucycles();
		dcycles += cycles2-cycles1 - cyclegap;
